...
tf.flags.DEFINE_string('X_input_dir', 'data/sketch2face_data/trainA',
                       'X input directory, default: data/sketch2face_data/trainA')
tf.flags.DEFINE_string('Y_input_dir', 'data/sketch2face_data/trainB',
                       'Y input directory, default: data/sketch2face_data/trainB')
tf.flags.DEFINE_string('X_output_file', 'data/tfrecords/sketch.tfrecords',
                       'X output tfrecords file, default: data/tfrecords/sketch.tfrecords')
tf.flags.DEFINE_string('Y_output_file', 'data/tfrecords/photo.tfrecords',
